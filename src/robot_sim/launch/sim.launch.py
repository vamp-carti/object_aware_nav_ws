...
def generate_launch_description():
    ...
    bridge_config_file = os.path.join(pkg_robot_sim, 'config', 'bridge_config.yaml')
    ...
    #         'use_sim_time': True,
    #         'lazy': False,
    #         # Force the bridge to override frame_id string metadata fields
    #         'expand_topic_names': True,
    #         '/scan.ros_frame_id': 'laser_frame',
    #         '/camera/image.ros_frame_id': 'camera_link',
    #         '/camera/depth_image.ros_frame_id': 'camera_link'
    #     }],
    #     arguments=[
    #         # 1. System Clock
    ...
    # 5. Updated Parameter Bridge pointing directly to your translation dictionary asset
    bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        output='screen',
